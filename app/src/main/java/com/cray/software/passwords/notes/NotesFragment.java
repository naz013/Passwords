...
public class NotesFragment extends BaseFragment implements SyncListener, SimpleListener {
    ...
    public void onFragmentResume() {
        ...
        if (anInterface != null) {
            ...
            anInterface.setClick(view -> startActivity(new Intent(getContext(), CreateNoteActivity.class)));
        }
    }
    ...
    public void loaderAdapter() {
        adapter = new PasswordsRecyclerAdapter(getContext(), DataProvider.getData(getContext(), false, true));
    ...
    private void showPopup(int position, View view) {
        ...
        if (el instanceof NoteInterfaceImpl) {
            final String[] items = {
