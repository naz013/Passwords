...
class NotesFragment : BaseFragment(), SimpleListener {
    ...
    override fun onFragmentResume() {
        ...
        loaderAdapter()
        if (anInterface != null) {
            anInterface!!.setTitle(getString(R.string.notes))
            anInterface!!.setClick { view -> startActivity(Intent(context, CreateNoteActivity::class.java)) }
        }
    }
    ...
    fun loaderAdapter() {
        adapter = PasswordsRecyclerAdapter(DataProvider.getData(context, false, true))
